...
EXTENSIONS = global_settings.LOCALE_PATHS + [".js"]
...
LOCALE_PATHS = (PROJ_ROOT / Path('locale'),  )  


# LOCALE_PATHS = (
#     os.path.join(PROJ_ROOT, "papermerge/contrib/admin/locale"),
# )
# LOCALE_PATHS = (PROJ_ROOT / Path('papermerge/contrib/admin/locale'),  )  
print(LOCALE_PATHS, '@'*50)
